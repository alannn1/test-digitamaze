<div>
    <div x-data class="flex h-screen">
        <div :class="$store.sidebar.open ? 'w-56 absolute left-0' : 'w-20'" class="bg-gray-100 text-white h-screen transition-all duration-300 ease-in-out overflow-hidden z-20">
            <button @click="$store.sidebar.toggle()" class="text-white z-30 top-4 transition duration-500" :class="$store.sidebar.open ? 'absolute left-48 -rotate-180' : 'absolute left-4'">
            ...
            <ul class="mt-[20vh] text-black w-full space-y-5 relative h-screen">
                <li class="px-4 py-2 hover:bg-white cursor-pointer">
                    <a href="{{ route('kelas') }}" class="flex items-center">
                        ...
                        <span x-show="$store.sidebar.open" class="ml-3 transition-opacity duration-500">Kelas</span>
                    </a>
                </li>
                <li class="px-4 py-2 hover:bg-white cursor-pointer">
                    <a href="{{ route('guru') }}" class="flex items-center">
                        ...
                        <span x-show="$store.sidebar.open" class="ml-3 transition-opacity duration-500">Guru</span>
                    </a>
                </li>
                <li class="px-4 py-2 hover:bg-white cursor-pointer">
                    <a href="{{ route('siswa') }}" class="flex items-center">
                        ...
                        <span x-show="$store.sidebar.open" class="ml-3 transition-opacity duration-500">Siswa</span>
                    </a>
                </li>
                <li class="px-4 py-2 hover:bg-white cursor-pointer">
                    <a href="{{ route('kelas.list') }}" class="flex items-center">
                        ...
                        <span x-show="$store.sidebar.open" class="ml-3 transition-opacity duration-500">Kelas List</span>
                    </a>
                </li>
                <li class="px-4 py-2 hover:bg-white cursor-pointer">
                    <a href="{{ route('guru.list') }}" class="flex items-center">
                        ...
                        <span x-show="$store.sidebar.open" class="ml-3 transition-opacity duration-500">Guru List</span>
                    </a>
                </li>
                <li class="px-4 py-2 hover:bg-white cursor-pointer">
                    <a href="{{ route('siswa.list') }}" class="flex items-center">
                        ...
                        <span x-show="$store.sidebar.open" class="ml-3 transition-opacity duration-500">Siswa List</span>
                    </a>
                </li>
                
                <li class="px-4 hover:bg-white cursor-pointer flex items-center mt-5">
                    <livewire:auth.logout>
                    <span x-show="$store.sidebar.open" class="ml-3 transition-opacity duration-500">Logout</span>
                </li>
            </ul>
        </div>
    </div>
